...
for (i in 1:12){
  ...
  {
    source("D:/Air Quality/GWR/Saves from GWR script/IDW_function_ECMWF.R")
    ########### 2013
    ...
    ##### kriging to 10km 
    ECMWF_SO4_jan_10km <-IDW_points(dawit=ECMWF_SO4_jan, resl_ras= 0.1, shp_UAE = "D:/Air Quality/GWR/UAE_boundary")
    names(ECMWF_SO4_jan_10km)<-"SO4_ECMWF"
    plot(ECMWF_SO4_jan_10km)
    
    writeRaster(ECMWF_SO4_jan_10km, sprintf(paste0("D:/Air Quality/GWR/new_analysis_2013_2015/ECMWF_IDW/ECMWF_SO4_%02d_10km.tif"),i) ,overwrite=TRUE)
  ...
  
  {
    ...
    ##### kriging to 10km 
    ECMWF_DUST_jan_10km <-IDW_points(dawit=ECMWF_DUST_jan, resl_ras= 0.1, shp_UAE = "D:/Air Quality/GWR/UAE_boundary")
    names(ECMWF_DUST_jan_10km)<-"DUST_ECMWF"
    plot(ECMWF_DUST_jan_10km)
    
    writeRaster(ECMWF_DUST_jan_10km, sprintf(paste0("D:/Air Quality/GWR/new_analysis_2013_2015/ECMWF_IDW/ECMWF_DUST_%02d_10km.tif"),i), overwrite=TRUE)
  ...
  
  {
    ...
    ##### kriging to 10km 
    ECMWF_SALT_jan_10km <-IDW_points(dawit=ECMWF_SALT_jan, resl_ras= 0.1, shp_UAE = "D:/Air Quality/GWR/UAE_boundary")
    names(ECMWF_SALT_jan_10km)<-"SALT_ECMWF"
    plot(ECMWF_SALT_jan_10km)
    
    writeRaster(ECMWF_SALT_jan_10km, sprintf(paste0("D:/Air Quality/GWR/new_analysis_2013_2015/ECMWF_IDW/ECMWF_SALT_%02d_10km.tif"),i), overwrite=TRUE)
  ...
  
  {
    ...
    ##### kriging to 10km 
    ECMWF_BC_jan_10km <-IDW_points(dawit=ECMWF_BC_jan, resl_ras= 0.1, shp_UAE = "D:/Air Quality/GWR/UAE_boundary")
    names(ECMWF_BC_jan_10km)<-"BC_ECMWF"
    plot(ECMWF_BC_jan_10km)
    
    writeRaster(ECMWF_BC_jan_10km, sprintf(paste0("D:/Air Quality/GWR/new_analysis_2013_2015/ECMWF_IDW/ECMWF_BC_%02d_10km.tif"),i), overwrite=TRUE)
  ...
  
  {
    ...
    ##### kriging to 10km 
    ECMWF_OM_jan_10km <-IDW_points(dawit=ECMWF_OM_jan, resl_ras= 0.1, shp_UAE = "D:/Air Quality/GWR/UAE_boundary")
    names(ECMWF_OM_jan_10km)<-"OM_ECMWF"
    plot(ECMWF_OM_jan_10km)
    
    writeRaster(ECMWF_OM_jan_10km, sprintf(paste0("D:/Air Quality/GWR/new_analysis_2013_2015/ECMWF_IDW/ECMWF_OM_%02d_10km.tif"),i), overwrite=TRUE)
...
# plot(OD_mean_jan)
  for (qq in 1:12){
    ...
    AOD_mean_jan<-raster(paste0("MODIS/AOD_mean_",name_mon,".tif"))/85
    ...
    ECMWF_OM_ECMWF_jan_10km_1<- raster(paste0("ECMWF_IDW/ECMWF_OM_",name_mon,"_10km.tif"))
    ECMWF_BC_ECMWF_jan_10km_1<- raster(paste0("ECMWF_IDW/ECMWF_BC_",name_mon,"_10km.tif"))
    ECMWF_SALT_ECMWF_jan_10km_1<- raster(paste0("ECMWF_IDW/ECMWF_SALT_",name_mon,"_10km.tif"))
    ECMWF_DUST_ECMWF_jan_10km_1<- raster(paste0("ECMWF_IDW/ECMWF_DUST_",name_mon,"_10km.tif"))
    ECMWF_SO4_jan_10km_1<- raster(paste0("ECMWF_IDW/ECMWF_SO4_",name_mon,"_10km.tif"))
    ...
    ED_sampled <- resample(ED,r_moni,"bilinear")
    ...
    ED_sampled <- mask(ED_sampled, r_moni)
    ...
    # ED<- raster("ED_10km.tif")   ## constant for all months
    ED_sp<- as(ED_sampled, 'SpatialPointsDataFrame')
    names(ED_sp)<- "ED"
    
    
    combined_data_pnt<-cbind(r_moni_sp,r_AOD_sampled_sp,BIAS_sp,LU__desert10km_sp,LU__urban10km_sp, ECMWF_OM_ECMWF_jan_10km_sp,ECMWF_BC_ECMWF_jan_10km_sp,ECMWF_SALT_ECMWF_jan_10km_sp, ECMWF_DUST_ECMWF_jan_10km_sp, ECMWF_SO4_jan_10km_sp )
    
    combined_data_pnt_ED<- cbind(combined_data_pnt, ED_sp)
    #plot(ED)

    
    bwG_pnt <- gwr.sel( Moni ~  Modis_AOD + desert_fraction + ECMWF_DUST_jan_10km ,#+  urban_fraction+ ED,# + ECMWF_SO4_jan_10km, #  ED + urban_fraction +desert_fraction + ED ++ ECMWF_SALT_jan_10km  , #+ ECMWF_SALT_jan_10km,# + ECMWF_SALT_jan_10km + ECMWF_DUST_jan_10km, #+ desert_fraction ++ ECMWF_DUST_jan_10km +ECMWF_SO4_jan_10km++    ECMWF_DUST_jan_10km +ECMWF_DUST_jan_10km + ECMWF_SO4_jan_10km
                       data= combined_data_pnt_ED,  gweight = gwr.Gauss, #RMSE=T,
    ...
    # }else{
      gwrG_pnt <- gwr(Moni ~  Modis_AOD +   urban_fraction+desert_fraction +ECMWF_DUST_jan_10km ,# + ED, #urban_fraction +desert_fraction +  + ECMWF_SO4_jan_10km,# ED + urban_fraction + desert_fraction + ED + desert_fraction + ECMWF_SALT_jan_10km,#   , #  ECMWF_DUST_jan_10km ++ ECMWF_DUST_jan_10km + ECMWF_BC_jan_10km
                      data= combined_data_pnt_ED,  bandwidth = bwG_pnt*2.5, # 0.2/bwG_pnt
  ...
  save(result_monthly, file="D:/Air Quality/GWR/new_analysis_2013_2015/result_Rdata/result_regression_DU_UR_DE_ED_IDW_opt.RData")
...
load("D:/Air Quality/GWR/new_analysis_2013_2015/result_Rdata/result_regression_DU_UR_DE_ED_IDW_opt.RData")

output_folder<- "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/PhD_DG/GWR_V1/Out_put_images/11/11/"
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  png(paste0(output_folder,"Coefffi_Dust.png"),
  ...
  # 
  # 
  # png(paste0(output_folder,"Coefffi_SO4.png"),
  #     width = 1680, height = 1050, units = "px", pointsize = 30,
  #     bg = "white", res = 150)
  # print(h)
  # dev.off()
  ...
  #   png(paste0(output_folder,"hist_SO4.png"),
  #       width = 1680, height = 1050, units = "px", pointsize = 30,
  #       bg = "white", res = 150)
  # print({
  ...
  png(paste0(output_folder,"Coefffi_URBAN.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  ### plots of histograms
    ...
    png(paste0(output_folder,"hist_URBAN.png"),
        width = 1680, height = 1050, units = "px", pointsize = 30,
        bg = "white", res = 150)
    print({
  ...
  png(paste0(output_folder,"Coefffi_DESERT.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  ### plots of histograms
    ...
    png(paste0(output_folder,"hist_DESERT.png"),
        width = 1680, height = 1050, units = "px", pointsize = 30,
        bg = "white", res = 150)
    print({
  ...
  png(paste0(output_folder,"Coefffi_ED.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  ### plots of histograms
    ...
    png(paste0(output_folder,"hist_ED.png"),
        width = 1680, height = 1050, units = "px", pointsize = 30,
        bg = "white", res = 150)
    print({
  ...
  png(paste0(output_folder,"Pred_bias.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  ### plots of histograms
    ...
    png(paste0(output_folder,"hist_pre_BIAS.png"),
        width = 1680, height = 1050, units = "px", pointsize = 30,
        bg = "white", res = 150)
    print({
  ...
  png(paste0(output_folder,"Constant_coeff.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  ### plots of histograms
    ...
    png(paste0(output_folder,"hist_cons_error.png"),
        width = 1680, height = 1050, units = "px", pointsize = 30,
        bg = "white", res = 150)
    print({
...
###### ploting the ERRORS #############
  ...
  output_folder<- "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/PhD_DG/GWR_V1/Out_put_images/11/" 
  #### DUST SE ####
  ...
  png(paste0(output_folder,"MAP_DUST_ED.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  #vec_all<- as.vector(cons_plot)
  png(paste0(output_folder,"hist_DUST_ED.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print({
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  # 
  # 
  # png(paste0(output_folder,"MAP_SO4_SE.png"),
  #     width = 1680, height = 1050, units = "px", pointsize = 30,
  #     bg = "white", res = 150)
  # print(h)
  # dev.off()
  ...
  # 
  # #vec_all<- as.vector(cons_plot)
  # png(paste0(output_folder,"hist_SO4_SE.png"),
  #     width = 1680, height = 1050, units = "px", pointsize = 30,
  #     bg = "white", res = 150)
  # print({
  ...
  png(paste0(output_folder,"MAP_URBAN_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  #vec_all<- as.vector(cons_plot)
  png(paste0(output_folder,"hist_URBAN_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print({
  ...
  png(paste0(output_folder,"MAP_DESERT_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  #vec_all<- as.vector(cons_plot)
  png(paste0(output_folder,"hist_DESERT_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print({
  ...
  # 
  # 
  # png(paste0(output_folder,"MAP_ED_SE.png"),
  #     width = 1680, height = 1050, units = "px", pointsize = 30,
  #     bg = "white", res = 150)
  # print(h)
  # dev.off()
  ...
  # 
  # #vec_all<- as.vector(cons_plot)
  # png(paste0(output_folder,"hist_ED_SE.png"),
  #     width = 1680, height = 1050, units = "px", pointsize = 30,
  #     bg = "white", res = 150)
  # print({
  ...
  png(paste0(output_folder,"MAP_PRED_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  #vec_all<- as.vector(cons_plot)
  png(paste0(output_folder,"hist_PRED_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print({
  ...
  png(paste0(output_folder,"MAP_INTER_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print(h)
  dev.off()
  ...
  #vec_all<- as.vector(cons_plot)
  png(paste0(output_folder,"hist_INTER_SE.png"),
      width = 1680, height = 1050, units = "px", pointsize = 30,
      bg = "white", res = 150)
  print({
